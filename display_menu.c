...
/*   Updated: 2025/01/19 20:37:04 by tbeauman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	display_menu2(t_env *e)
{
	mlx_string_put(e->mlx, e->win, 5, 160,
			0x00ffffff, "-I pour Burning Julia");
	mlx_string_put(e->mlx, e->win, 5, 175,
			0x00ffffff, "-T pour Tricorne");
	mlx_string_put(e->mlx, e->win, 5, 190,
	...
	mlx_string_put(e->mlx, e->win, 5, 240,
			0x00ffffff, "Pour toutes les fractales sauf celle de Newton, appuyez sur O/P");
	mlx_string_put(e->mlx, e->win, 5, 260,
			0x00ffffff, "pour diminuer/augmenter l'exposant");
	...
	mlx_string_put(e->mlx, e->win, 10, 380,
			0x00ffffff, "-Appuyez sur la touche Enter");
}
